...
# ==== OPERAÇÕES 3D =====
def build_ortogonal_projection_matrix(dx, dy, dz, angle_x, angle_y):
    projection_matrix = transform_translate_3d(dx, dy, dz)
    projection_matrix = projection_matrix.dot(transform_basic_rotation_3d("x", angle_x))
    projection_matrix = projection_matrix.dot(transform_basic_rotation_3d("y", angle_y))
